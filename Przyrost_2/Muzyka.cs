namespace Przyrost_2
{
    ...
    public partial class Muzyka : DbContext
    {
        ...
        public virtual DbSet<Czlonkowie> Czlonkowies { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Czlonkowie>()
                .Property(e => e.nazw_zesp)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<Zespoly>()
                .HasMany(e => e.Czlonkowies)
                .WithOptional(e => e.Zespoly)
                .HasForeignKey(e => e.nazw_zesp);
        }
    }
}
